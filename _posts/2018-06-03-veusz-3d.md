...
Multiple 3D graph widgets in a single scene           |
:-----------------------------------------------------:
...
Multiple 3D axis widgets in a single graph          |
:---------------------------------------------------:
...
3d line function                                  | 3d surface function                                    |
:------------------------------------------------:|:-------------------------------------------------------:
![function3d (line)](/media/3d_function_line.png) | ![function3d 9surface)](/media/3d_function_surface.png)|
...
3D surface plotting example                   |
:---------------------------------------------:
![surface3d example](/media/3d_surface.png)   |
